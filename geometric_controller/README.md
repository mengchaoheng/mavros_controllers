...
- /geometric_controller/KR_x (default: 3.0; roll attitude error angular-acceleration gain)
- /geometric_controller/KR_y (default: 3.0; pitch attitude error angular-acceleration gain)
- /geometric_controller/KR_z (default: 2.0; yaw attitude error angular-acceleration gain)
- /geometric_controller/KOmega_x (default: 1.0; roll rate angular-acceleration gain divisor)
- /geometric_controller/KOmega_y (default: 1.0; pitch rate angular-acceleration gain divisor)
- /geometric_controller/KOmega_z (default: 1.0; yaw rate angular-acceleration gain divisor)
